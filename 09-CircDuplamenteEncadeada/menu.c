...
TAD Lista Circular Encadeada (Circular Doubly Linked List)
---------------------------------------------------
    ...
    do
    {
        ...
        case 2:
            if (listaCriada)
            {
                ...
                teste = cdllInsertFirst(cdll, (void *)a);
                if (teste == TRUE)
                {
                    printf("\nElemento inserido!");
                }
        ...
        case 3:
            if (listaCriada)
            {
                ...
                teste = cdllInsertLast(cdll, (void *)a);
                if (teste == TRUE)
                {
                    printf("\nElemento inserido!");
                }
        ...
        case 4:
            if (listaCriada)
            {
                ...
                teste = cdllInsertAfterSpec(cdll, (void *)&spec->cod, (void *)a, cmp);
                if (teste == TRUE)
                {
                    printf("\nElemento inserido!");
                }
        ...
        case 5:
            if (listaCriada)
            {
                ...
                scanf("%d", &spec->cod);
                a = cdllRemoveSpec(cdll, (void *)&spec->cod, cmp);
